...
fancy buttons is a collection of fun and weird, ready-to-use components and microinteractions built (mainly) with:
...
fancy buttons is open source and free to use. You can use it for personal or commercial projects.
