...
A generalized version of this component (where you can control any CSS property) is available in the [Text Cursor Proximity](https://uwuui.com/docs/components/text/text-cursor-proximity.md) component.
